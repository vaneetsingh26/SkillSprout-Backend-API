...
exports.getCourseDetails = async (req, res) => {
  try {
    ...
    // Ensure the course isn't a draft if a student is trying to view it
...
exports.deleteCourse = async (req, res) => {
  try {
    ...
    // 3. Delete sections and sub-sections
    ...
    // 4. Remove Course from the Category
    await Category.findByIdAndUpdate(course.category, {
      $pull: { courses: courseId },
    });

    // 5. Remove Course from the Instructor's Profile
